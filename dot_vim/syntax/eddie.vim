...
:syn keyword eddieType SMTP POP3TIMING RADIUS PING SNMP HTTP MYSQL NETAPP
:syn keyword eddieType PRTDIAG FS NFS NETAPP_ENV NETAPP_NFS IMAPTIMING
...
:syn match eddieStatement +query=+
...
:syn match eddieStatement +netapp=+
...
:syn match eddieStatement +toemail=+
:syn match eddieStatement +fromemail=+
:syn match eddieStatement +username=+
